...
dhis2.appr.generateDataReport = function()
{
    ...
    $.get( "generateDataSetReport.action", dataReport, function( data ) {
		...
		$( "#approvalvalidationButton" ).show(); // at 459
        $( "#approvalvalidationButton" ).hide(); // at 486
        $( "#approvalvalidationButton" ).hide(); // at 512
        $( "#approvalvalidationButton" ).show(); // at 536
        $( "#approvalvalidationButton" ).show(); // at 546
